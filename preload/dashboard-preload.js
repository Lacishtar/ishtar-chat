...
contextBridge.exposeInMainWorld('api', {
  ...
  getPresetList: () => ipcRenderer.invoke('theme-preset:list'),
  applyPreset: (presetId) => ipcRenderer.invoke('theme-preset:apply', presetId),
  resetCategory: (category) => ipcRenderer.invoke('theme-preset:reset-category', category),
