...
contextBridge.exposeInMainWorld('api', {
  ...
  listCreditsThemes: () => ipcRenderer.invoke('credits:list-themes'),
  getCreditsTheme: () => ipcRenderer.invoke('credits:get-theme'),
  setCreditsTheme: (themeId) => ipcRenderer.invoke('credits:set-theme', themeId),
  setCreditsSectionLabel: (sectionId, label) => ipcRenderer.invoke('credits:set-section-label', sectionId, label),
