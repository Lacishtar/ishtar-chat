...
export const SEARCH_INDEX = [
  ...
  { objectId: 'author', sectionId: 'bubble', label: 'Tên — Bubble riêng', keywords: ['tên', 'bubble', 'radius', 'viền', 'shadow', 'texture', 'tai thỏ'] },
  ...
  { objectId: 'message', sectionId: 'bubble', label: 'Nội dung — Bubble riêng', keywords: ['nội dung', 'message', 'bubble', 'radius', 'viền', 'shadow', 'texture', 'tai thỏ'] },
